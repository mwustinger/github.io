...
description: >
  This paper introduces the Denoising Diffusion Adaptive Search Procedure (DDASP) for the α-domination problem on social networks, outperforming conventional metaheuristics.
image: 
